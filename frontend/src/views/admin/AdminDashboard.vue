...
const loadData = async () => {
    ...
    try {
        const [tenantRes, ordersRes, salesRes] = await Promise.all([
            ...
            axios.get(`/api.php/analytics/sales?company_id=${companyId}`).catch(() => ({ data: {} }))
        ])
        ...
        stats.value.todaySales = salesRes.data?.today_total || 0
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <main class="max-w-7xl mx-auto px-6 py-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <router-link to="/pos" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-orange-200 transition-all group text-center">
                ...
                <router-link to="/caja" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-green-200 transition-all group text-center">
                ...
                <router-link to="/cocina" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-yellow-200 transition-all group text-center">
                ...
                <router-link to="/demo/analytics" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-blue-200 transition-all group text-center">
                ...
                <router-link to="/admin/menu" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-orange-200 transition-all group text-center">
                ...
                <router-link to="/admin/team" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-purple-200 transition-all group text-center">
